...
These tables show the first and maximum version of iOS or iPadOS for each iPhone, iPad, and iPod touch. Only major versions (e.g. <i>iOS 26</i>) are shown, not point releases (e.g. <i>iOS 26.5.1</i>). Information about vintage ({% include badge-vintage.html %}) and obsolete ({% include badge-obsolete.html %}) device status comes from <a href="https://support.apple.com/en-us/102772">this page</a>.
